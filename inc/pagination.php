...
if ( ! function_exists( 'safehaven_pagination' ) ) {
	/**
	 ...
	 */
	function safehaven_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'safehaven' ),
				'next_text'          => __( '&raquo;', 'safehaven' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'safehaven' ),
			)
		);
