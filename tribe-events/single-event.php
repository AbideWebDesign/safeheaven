...
<div id="tribe-events-content" class="tribe-events-single bg-light">
	<div class="container">
		<div class="row">
			<div class="col-12">
				<!-- Notices -->
								...
								<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
									...
									<div class="tribe-events-single-event-description tribe-events-content">
										...
										<?php if ( get_field('include_button') ): ?>
											...
											<div class="mt-3">
												<a href="<?php the_field('event_button_link'); ?>" id="btn-event" class="btn btn-primary"><?php the_field('event_button_label'); ?></a>
											</div>
